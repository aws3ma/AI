...
problem4 = Search_problem_from_explicit_graph(
    {'a','b','c','d','e','g','h','j'},
    [],
    start = 'g',
    goals = {'k','g'})
...
# try
"""
print(problem1.start_node())
print(problem1.is_goal('g'))
print(problem1.neighbors('a'))
print(problem1.heuristic('mail'))
print(cyclic_delivery_problem.heuristic('mail'))
"""
# try
"""
arc1 = Arc('a', 'c', 1)
arc2 = Arc('c', 'g', 1)
path0 = Path('a')
path1 = Path(path0, arc1)
path2 = Path(path1, arc2)
print(path2.__repr__())
print(path2.end())
print(path2.cost)
"""